...
Original file is located at
    https://colab.research.google.com/drive/15kPiIvGmAxhon5W_ewHxWoMOrA-dqS9u
...
train_data = DataLoader(Load_train, batch_size=8, shuffle=True, num_workers=1)
val_data = DataLoader(Load_val, batch_size=8, shuffle=True, num_workers=1)
...
for gpu_count in gpu_counts:        
    ...
    mp.spawn(train, args=(world_size, fcn, 16, epochs), nprocs=world_size, join=True)
